...
def train() -> dict:
    """Fit Linear Regression on W1 historical data (FY2000–FY2025)."""
...
def run() -> dict:
    """Train, forecast, plot Figure 3, return results dict."""
    set_style()
    res = train()
    ...
    ax.set_title("Figure 3 — Linear Regression Forecast: India Wind Capacity (FY2026–FY2030)\n"
...
if __name__ == "__main__":
    print("\n── Model 1 · Linear Regression (W1 Dataset) ───────────────")
    run()
